...
{
    public $amount, $address, $fee_percentage, $fee = 0, $error, $total_wd, $max_wd, $min_wd, $remaining_contract, $success, $bonus, $btt_price, $btt, $submit=true;
    ...
    public function submit()
    {
        ...
        if ($this->total_wd->sum('amount') + $this->amount < $this->min_wd) {
            Member::where('id_member', auth()->id())->updated([
